...
public class DataServiceImpl implements DataService {
    ...
    private static final String IS_USER_ERROR = ". Is user-error: ";
    ...
    public List<Product> getAllProducts() throws DataServiceException {
        ...
        if(products.isEmpty()){
            ...
            logger.error(errorMessage + " " + causeOfError + IS_USER_ERROR + isUserError);
    ...
    @Override
    public Product getByProductId(Long productId) throws DataServiceException {
    ...
    @Override
    public void deleteProductById(Long productId) throws DataServiceException {
    ...
    @Override
    public Product createProduct(Product product) throws DataServiceException {
    ...
    private void validateProduct(Product product) throws DataServiceException {
    ...
    @Override
    public Product updateProduct(Long productID, Product newProduct) throws DataServiceException {
    ...
    @Override
    public List<Orders> getAllOrders() throws DataServiceException {
    ...
    @Override
    public Orders getByOrderId(Long orderId) throws DataServiceException {
    ...
    @Override
    public void deleteOrderById(Long orderId) throws DataServiceException {
    ...
    @Override
    public Orders createOrder(Orders orders) throws DataServiceException {
    ...
    @Override
    public OrderItem createOrderItem(OrderItem orderItem) throws DataServiceException {
    ...
    @Override
    public OrderItem getOrderItemById(Long id) throws DataServiceException {
        ...
        if(ret.isPresent()){
            ...
            String causeOfError = "Unknown order id.";
            boolean isUserError = true;
            logger.error("getOrderItemById() - ERROR :" + errorMessage + " " + causeOfError + IS_USER_ERROR + isUserError);
            throw new DataServiceException(errorMessage, causeOfError, isUserError);
        }
    }

    @Override
    public List<OrderItem> getAllOrderItemsForOrderId(Long orderId) throws DataServiceException {
    ...
    @Override
    public OrderItem updateOrderItem(Long itemId, OrderItem newOrderItem) throws DataServiceException {
    ...
    @Override
    public Orders updateOrder(Long orderID, Orders newOrders) throws DataServiceException {
    ...
    private void validateOrder(Orders newOrders) throws DataServiceException {
    ...
    private void validateCustomerData(Orders newOrders) throws DataServiceException {
    ...
    private void validateOrderItem(OrderItem orderItem) throws DataServiceException {
        if(orderItem == null){
